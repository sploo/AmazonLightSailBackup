# AWS LightSail Backup Lambda Function Project
...
Execute unit tests
```
    cd "LightSailBackup/test/LightSailBackup.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "LightSailBackup/src/LightSailBackup"
    dotnet lambda deploy-function
```
# Running Function

Input JSON as below on CloudWatch rule or any trigger:
